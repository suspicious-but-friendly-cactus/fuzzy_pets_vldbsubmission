...
class Garbler : public GCEnv {
 public:
  ...
  std::vector<WireLabel> inputOfServer(const BitVector &input);

  std::vector<WireLabel> inputOfClient(const size_t size);

  void outputToClient(const std::vector<WireLabel> &outputLabels);
...
class Evaluator : public GCEnv {
 public:
  ...
  std::vector<WireLabel> inputOfServer(const size_t size);

  std::vector<WireLabel> inputOfClient(const BitVector &input);

  BitVector outputToClient(const std::vector<WireLabel> &outputLabels);
...
class SIMDGarbler : public SIMDGCEnv {
 public:
  ...
  virtual std::vector<WireLabel> inputOfServer(const BitVector &input);
  virtual std::vector<SIMDWireLabel> inputOfServer(
      const std::vector<BitVector> &input);

  virtual std::vector<SIMDWireLabel> inputOfClient(const size_t size);

  virtual void outputToClient(const std::vector<SIMDWireLabel> &outputLabels);
...
class SIMDEvaluator : public SIMDGCEnv {
 public:
  ...
  virtual std::vector<WireLabel> inputOfServer(const size_t size);
  virtual std::vector<SIMDWireLabel> inputOfServerSIMD(const size_t size);

  virtual std::vector<SIMDWireLabel> inputOfClient(
      const std::vector<BitVector> &input);

  virtual std::vector<BitVector> outputToClient(
...
class SIMDGarblerPhases : public SIMDGarbler {
 public:
  ...
  std::vector<SIMDWireLabel> inputOfClientOffline(const size_t size);

  void inputOfClientOnline();

  void outputToClient(const std::vector<SIMDWireLabel> &outputLabels);
 ...
 private:
  std::vector<SIMDWireLabel> clientInputLabels;
};
...
class SIMDEvaluatorPhases : public SIMDEvaluator {
 public:
  ...
  std::vector<SIMDWireLabel> inputOfClientOnline(
      const std::vector<BitVector> &input, const BitVector &randChoices);

  std::vector<BitVector> outputToClient(
      const std::vector<SIMDWireLabel> &outputLabels);
